      ...
      <div className="hidden lg:flex flex-1 bg-[#D72322] relative overflow-hidden flex-col justify-between p-16">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-white text-6xl font-semibold leading-[1.1] tracking-tight mb-8">
            Welcome back <br />
            <span className="text-white/80">to Gearhouse.</span>
          </h1>
          <p className="text-white/70 text-xl font-normal max-w-md leading-relaxed">
            Access your fleet dashboard, manage maintenance records, and stay updated with real-time analytics.
          </p>
        </div>
      ...
      <div className="flex-[0.8] flex flex-col items-center justify-center p-8 bg-[#F8F9FB] lg:bg-white overflow-y-auto">
        <div className="w-full max-w-[440px]">
          ...
          <div className="mb-10 text-left">
            <h2 className="text-[#04091E] text-4xl font-semibold mb-3 tracking-tight">Login</h2>
            <p className="text-[#747681] text-lg font-normal">Enter your credentials to continue.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-[#D72322] hover:underline"
                >
                  Forgot password?
                </button>
              </div>
            ...
            <div className="flex items-center gap-2 py-1 cursor-pointer" onClick={() => setRememberMe(!rememberMe)}>
               <div className={`size-5 rounded border flex items-center justify-center transition-all ${rememberMe ? 'bg-[#D72322] border-[#D72322]' : 'bg-white border-[#EEEFF2]'}`}>
                  {rememberMe && <div className="size-2 bg-white rounded-full"></div>}
               </div>
               <span className="text-sm text-[#747681] font-normal select-none">Remember me for 30 days</span>
            </div>
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-4 text-[#A3A6B4] font-medium tracking-widest">Or login with</span></div>
            </div>
